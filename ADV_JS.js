...
document.body.style.backgroundColor ="#212926";
var music;
var pushed;

play_music = new sound('Tom_Jerry.mp3');
pushed = new sound ('Toggle.mp3');
...
//            hide_text =document.querySelector("#effect");
//            hide_text.style.visibility ="hidden";
            document.body.style.backgroundColor ="#2f6c57";
     
 function Timer(){
    document.querySelector('#spark').style.visibility = "hidden"; 
     hide_button =document.querySelector("#myButton");
     hide_button.style.visibility = "hidden";
     hide_text=document.querySelector("#main");
     hide_text.style.visibility ="hidden";
     ...
     hide_text =document.querySelector("#effect");
     hide_text.style.visibility ="hidden";
    console.log("Did you upload the image?");
}
